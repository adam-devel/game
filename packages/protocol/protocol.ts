import { Board, Turn, Gameover } from "@game/game";
...
export type Schema = {
  ...
  */
  Join: [version: typeof VERSION, type: "JOIN", wantTurn: Turn | null, wantFirst: boolean]
  ...
  */
  Start: [version: typeof VERSION, type: "START", board: Board, yourTurn: Turn, currentTurn: Turn]
  ...
  * but the server remains the authority.
    */
  Sync: [version: typeof VERSION, type: "SYNC", board: Board, currentTurn: Turn]
